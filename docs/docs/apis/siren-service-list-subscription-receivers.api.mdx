...
api:
  {
    "operationId": "SirenService_ListSubscriptionReceivers",
    "responses":
      {
        "200":
          {
    ...
    "description": "List receivers of a subscription",
    "method": "get",
    "path": "/v1beta1/subscriptions/{subscription_id}/receivers",
    "info":
      {
        "title": "Siren APIs",
    ...
    "postman":
      {
        "name": "List receivers of a subscription",
        "description": { "type": "text/plain" },
        "url":
          {
            "path":
              ["v1beta1", "subscriptions", ":subscription_id", "receivers"],
            "host": ["{{baseUrl}}"],
            "query": [],
            "variable":
              [
