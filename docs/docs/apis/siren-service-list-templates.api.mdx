---
id: siren-service-list-templates
        ...
        "url":
          {
            "path": ["v1beta1", "templates"],
            "host": ["{{baseUrl}}"],
            "query": [{ "disabled": false, "key": "tag", "value": "" }],
            "variable": [],
          },
...
<details style={{"marginBottom":"1rem"}} data-collapsed={false} open={true}><summary style={{}}><strong>Query Parameters</strong></summary><div><ul><ParamsItem className={"paramsItem"} param={{"name":"tag","in":"query","required":false,"schema":{"type":"string"}}}></ParamsItem></ul></div></details><div><ApiTabs><TabItem label={"200"} value={"200"}><div>
