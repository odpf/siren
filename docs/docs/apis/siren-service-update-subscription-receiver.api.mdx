...
api:
  {
    "operationId": "SirenService_UpdateSubscriptionReceiver",
    "responses":
      {
        "200":
          {
    ...
    "description": "Update a receiver of a subscription",
    "method": "put",
    "path": "/v1beta1/subscriptions/{subscription_id}/receivers/{receiver_id}",
    "jsonRequestBodyExample": { "labels": {} },
    "info":
      {
        "title": "Siren APIs",
    ...
    "postman":
      {
        "name": "Update a receiver of a subscription",
