---
id: siren-service-create-receiver
title: "create a receiver"
description: "create a receiver"
sidebar_label: "create a receiver"
hide_title: true
hide_table_of_contents: true
api: {"operationId":"SirenService_CreateReceiver","responses":{"200":{"description":"A successful response.","content":{"application/json":{"schema":{"type":"object","properties":{"id":{"type":"string","format":"uint64"}}}}}},"default":{"description":"An unexpected error response.","content":{"application/json":{"schema":{"type":"object","properties":{"code":{"type":"integer","format":"int32"},"message":{"type":"string"},"details":{"type":"array","items":{"type":"object","properties":{"@type":{"type":"string"}},"additionalProperties":{}}}}}}}}},"requestBody":{"content":{"application/json":{"schema":{"type":"object","properties":{"name":{"type":"string"},"type":{"type":"string"},"labels":{"type":"object","additionalProperties":{"type":"string"}},"configurations":{"type":"object"},"parent_id":{"type":"string","format":"uint64"}}}}},"required":true},"tags":["Receiver"],"description":"create a receiver","method":"post","path":"/v1beta1/receivers","jsonRequestBodyExample":{"name":"string","type":"string","labels":{},"configurations":{},"parent_id":"string"},"info":{"title":"Siren APIs","description":"Documentation of our Siren API with gRPC and\ngRPC-Gateway.","version":"0.6"},"postman":{"name":"create a receiver","description":{"type":"text/plain"},"url":{"path":["v1beta1","receivers"],"host":["{{baseUrl}}"],"query":[],"variable":[]},"header":[{"key":"Content-Type","value":"application/json"},{"key":"Accept","value":"application/json"}],"method":"POST","body":{"mode":"raw","raw":"\"\"","options":{"raw":{"language":"json"}}}}}
