---
id: siren-service-update-receiver
title: "update a receiver"
description: "update a receiver"
sidebar_label: "update a receiver"
hide_title: true
hide_table_of_contents: true
api: {"operationId":"SirenService_UpdateReceiver","responses":{"200":{"description":"A successful response.","content":{"application/json":{"schema":{"type":"object","properties":{"id":{"type":"string","format":"uint64"}}}}}},"default":{"description":"An unexpected error response.","content":{"application/json":{"schema":{"type":"object","properties":{"code":{"type":"integer","format":"int32"},"message":{"type":"string"},"details":{"type":"array","items":{"type":"object","properties":{"@type":{"type":"string"}},"additionalProperties":{}}}}}}}}},"parameters":[{"name":"id","in":"path","required":true,"schema":{"type":"string","format":"uint64"}}],"requestBody":{"content":{"application/json":{"schema":{"type":"object","properties":{"name":{"type":"string"},"labels":{"type":"object","additionalProperties":{"type":"string"}},"configurations":{"type":"object"},"parent_id":{"type":"string","format":"uint64"}}}}},"required":true},"tags":["Receiver"],"description":"update a receiver","method":"put","path":"/v1beta1/receivers/{id}","jsonRequestBodyExample":{"name":"string","labels":{},"configurations":{},"parent_id":"string"},"info":{"title":"Siren APIs","description":"Documentation of our Siren API with gRPC and\ngRPC-Gateway.","version":"0.6"},"postman":{"name":"update a receiver","description":{"type":"text/plain"},"url":{"path":["v1beta1","receivers",":id"],"host":["{{baseUrl}}"],"query":[],"variable":[{"disabled":false,"description":{"content":"(Required) ","type":"text/plain"},"type":"any","value":"","key":"id"}]},"header":[{"key":"Content-Type","value":"application/json"},{"key":"Accept","value":"application/json"}],"method":"PUT","body":{"mode":"raw","raw":"\"\"","options":{"raw":{"language":"json"}}}}}
