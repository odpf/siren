---
id: siren-service-update-subscription
                ...
                "schema":
                  {
                    ...
                    "properties":
                      {
                        "urn": { "type": "string" },
                        "namespace": { "type": "string", "format": "uint64" },
                        "receivers":
                          {
                            "type": "array",
                            "items":
