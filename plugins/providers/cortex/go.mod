module github.com/goto/siren/plugins/providers/cortex

go 1.21

require (
	github.com/goto/siren v0.6.7
...
require (
	...
	github.com/goto/salt v0.3.5 // indirect
...
replace github.com/goto/siren => ../../../../siren
