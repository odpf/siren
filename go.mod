...
require (
	...
	github.com/cortexproject/cortex v1.7.1-0.20210310163109-5d23b16190f6 // indirect
	...
	github.com/vektra/mockery/v2 v2.40.1 // indirect
	...
	go.opentelemetry.io/contrib/samplers/probability/consistent v0.16.0 // indirect
